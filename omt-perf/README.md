...
- `doctor.sh`: runtime inspection for socket, hooks, cached battery data, hot paths, and expanded tail preview
- `refresh-battery-bar.sh`: width-sensitive battery bar refresh for client resize events
- `refresh-status-tail.sh`: compact/full tail cache refresh driven by theme templates, reserving sub-80 space for sessions
